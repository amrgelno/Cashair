...
echo"<script> alert('يرجي أختيار أسم العميل ثم الضغط علي زر تاكيد') </script>";	
...
<td>Price:
<select name="price">
<option value="<?php echo $row->price?>">تجاري:- <?php echo $row->price?>    </option>
<option value="<?php echo $row->price2?>">تجزئه:- <?php echo $row->price2?>     </option>
<option value="<?php echo $row->price3?>"> نصف جمله:-<?php echo $row->price3?>     </option>
</select>
</td>
<td>Qsupply:
<input value="<?php echo $row->Qsupply?>"  name="Qsupply"  type="input"  style="background-color:#FFF;width:100px; border:none;"  onmouseover='calert();'/>
...
<input  type="text"     name="Amount"  required="required"  id="Amount"   onkeyup="typeSCc()"/>
