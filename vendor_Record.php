...
<div id="loader">
<div class="logo"><img src="img/Vendors_records.png" class="loading-logo"/></div>
...
<span style='font-weight:bold; background:#06C; color:white; ' >  <strong> Add new vendor  أدخال مورد جديد </strong>    </span> <br />   <br />   <br /> 

<form action="vendor_Record.php"  method="post">
...
class vendor_record  extends  condb{        
...
$sel_tb="select * from   vendor_record ";
...
<td  width="45"><input type="text"   name="Name"  value="<?php  echo $row->Name?>"   /> </td>
<td  width="57"><input type="text"  name="TELEPHONE"    value="<?php  echo $row->TELEPHONE?>"  /> </td> 
<td  width="57"><input type="text"  name="Address"  value="<?php  echo $row->Address?>" />  </td>   
<td   width="78"><input type="text"  name="Job" value="<?php  echo $row->job?>" /> </td> 
<td   width="78"><input type="text"   name="Seles_Rep"  value="<?php  echo $row->seles_rep?>" /> </td> 
<td   width="78"><input type="submit"   name="update"   value="تعديل" />  </td> 
</form>
<td   width="78"><form action="vendor_Record.php" method="post" >
<input type="hidden"   name="ID"  value="<?php  echo $row->ID?>"   />
...
$update_vendor="Update vendor_record  Set  Name='$Name' ,  TELEPHONE='$telephone' , Address='$Address' , job='$job',seles_rep='$seles_rep'  
...
$this->connectF()->query($update_vendor);


echo'<meta http-equiv="refresh"  content="3;url=vendor_Record.php"/>';
...
$Delete_vendor=" Delete from vendor_record where ID='$ID' ";

if(@$_POST['Delete']){


$this->connectF()->query($Delete_vendor);
...
$sel_tab="select * from   vendor_record  where Name='$Name' ";

$qusel_tab=$this->connectF()->query($sel_tab);


$ins_vendor="insert into  vendor_record(Name,TELEPHONE,Address,job,seles_rep) values ('$Name','$telephone','$Address','$job','$seles_rep')";
...
$qusel_tab=$this->connectF()->query($ins_vendor);
