...
<body>
<div id="loader">
<div class="logo"><img src="img/expense.png" class="loading-logo"/></div>
<!--<div id="loading"> </div>
...
<input type="text"  name="Title"  placeholder="اسم مصروف" />
...
$Exspense="insert into expense (TITLE,Amount,Time,Notes) values ('$Title','$Amount',NOW(),'$Notes')";
...
?>
echo'<meta http-equiv="refresh"  content="3;url=Expense.php"/>';
<?php
}
?>
...
$ins_cash2="insert into cash (AC,DEBIT,CREDIT,Time) VALUES  ('$Title',$Amount,'0',NOW())";


$query=$this->connectF()->query($ins_cash2);	
