...
<span style='font-weight:bold; background:#06C; color:white; ' > update Seles Invoice  تعديل علي  فاتوره مشتريات</span> <br />
<?php

include("connect.php");


class Editpurorder extends  condb{        
