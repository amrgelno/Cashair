...
class Editpurchasereturns  extends  condb{        
...
<span style='font-weight:bold; background:#06C; color:white; ' > update Seles Invoice  تعديل علي  فاتوره مردودات مشتريات    </span> <br />
...
<form action="Edit_purreturn.php"  method="post">  <!--first form -->
...
#echo"request sent";
#echo'<meta http-equiv="refresh"  content="3;url=Edit_purreturn.php"/>';
...
#echo "<meta http-equiv='refresh'  content='1,url=Edit_purreturn.php' />" ;
